...
public class ProxyGenerator
{
	...
	public String generateProxy(String proxyName, Class<?> classToProxy, HashSet<String> methodOverrides, HashSet<String> implementedInterfaces, boolean isInterface) throws IOException
	{
